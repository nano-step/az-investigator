# Lesson: capture-lesson.sh failed under set -u when USER env var unset
...
| **Cost first time** | 5 minutes |
| **Tool / file / quirk** | capture-lesson.sh |
| **Triggers re-find** | capture-lesson USER unbound variable set -u |
